      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="font-heading text-4xl font-bold leading-tight tracking-tight text-coffee-700 md:text-6xl">
            Single-Origin
            <br />
            <span className="italic text-gold-700">Indonesian Beans</span>
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-base text-dark-600 md:text-lg">
            Discover our carefully curated selection, each with its own unique
            character and story.
          </p>
        </motion.div>
            ...
            >
              <Card className="group h-full overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-gold-400/50">
                <div className="relative aspect-[4/3] overflow-hidden">
                  <img
                    src={product.image}
                    alt={`${product.name} coffee beans from ${product.origin}`}
                    loading="lazy"
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        {product.origin} &middot; {product.roast}
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
